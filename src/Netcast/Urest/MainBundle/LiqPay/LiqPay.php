...
class LiqPay
{
     ...
     * @throws InvalidArgumentException
     */
    public function cnb_form($params,$all = true)
    {
        $language = 'ru';
        ...
        if($all) {
            $button = '<a href="#" onclick="$(this).parent().submit()" class="btn btn-grey pull-left"><i class="fa fa-angle-right"></i> Оплатить полностью</a>';
        } else {
            $button = '<a href="#" onclick="$(this).parent().submit()" class="btn btn-grey pull-right"><i class="fa fa-angle-right"></i> Внести предоплату</a>';
        }
